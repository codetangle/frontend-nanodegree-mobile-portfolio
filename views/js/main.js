...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // Move the dom selector outside the for loop and assign it to a variable.
    var pizzaContainers = document.getElementsByClassName(".randomPizzaContainer");
    var numberPizzaContainers = pizzaContainers.length;

    for (var i = 0; i < numberPizzaContainers; i++) {

      // Replace document searches with the predefined variable
...
// Moved this variable assignement outside of the for loop
...
function updatePositions() {
  ...
  // Replace class selector with getElementsByClassName
  var items = document.getElementsByClassName('mover');

  // move the items.length outside of the for loop
  var itemsLength = items.length;

  // move body.scroll outside the for loop and save to a variable
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Calculate the number of moving pizzas to add to the screen
  var numMovingPizzas = Math.ceil(windowHeight / s) * cols;

  // Run the for loop from 0 to numMovingPizzas times
